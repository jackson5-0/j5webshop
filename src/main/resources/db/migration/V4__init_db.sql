...
values ('Kiss', 'Pista', 'admin', '$2a$10$M7/F8ur785gtN51RU.VdiOW/m5/R8HFGiYp9mEC3DjVHZE.PuNK3G', 1, 'ROLE_ADMIN');

insert into users(firstname, lastname, username, password, enabled, role)
values ('John', 'Doe', 'user', '$2a$10$JOjWsrAQH5/FmHQE6IXGx.lDMgET6lKXe9Icnnl06Fy3Zo8xOgNAW', 1, 'ROLE_USER');
