	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
				.antMatchers("/", "/products/**", "/products/count", "/products", "/myorders/top3")
					.permitAll()
				.antMatchers("/dashboard.html","/dashboard/","/adminproducts.html", "/admin/**","/order/**","/orders/**","/orders.html","/order.html", "/categories.html", "/adminusers.html", "/adminusers/**", "/reports.html")
					.hasRole("ADMIN")
				.antMatchers("/basket", "/basket.html", "/basket/**", "/myorders.html", "/userprofile.html")
					.hasRole("USER")
				.and()
				.formLogin()
